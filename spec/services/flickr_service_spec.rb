...
describe FlickrService do
  describe '.get_photos' do
    ...
    it 'fetches photos from Flickr API', :vcr do
      ...
      expect(photo).to include(url_thumbnail: a_string_matching('https://farm6.staticflickr.com'))
      expect(photo).to include(url_original: a_string_matching('https://farm6.staticflickr.com'))
